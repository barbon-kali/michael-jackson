    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/60 border-b border-border">
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <ul className="hidden md:flex gap-8 text-sm text-muted-foreground">
            <li><a href="#moves" className="hover:text-[color:var(--gold)] transition">الحركات</a></li>
            <li><a href="#journey" className="hover:text-[color:var(--gold)] transition">الرحلة</a></li>
            <li><a href="#masterclass" className="hover:text-[color:var(--gold)] transition">الماستركلاس</a></li>
            <li><a href="#join" className="hover:text-[color:var(--gold)] transition">انضم</a></li>
          </ul>
          <a href="#join" className="px-4 py-2 text-sm bg-primary text-primary-foreground font-medium hover:opacity-90 transition">
            ابدأ الآن
          </a>
        </nav>
      </header>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden grain">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center py-20">
          <div className="animate-slide-up text-right" dir="rtl">
            <p className="text-[color:var(--gold)] text-sm tracking-[0.4em] mb-6">★ ملك البوب · 1958 — ∞</p>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#moves" className="group px-8 py-4 bg-primary text-primary-foreground font-semibold tracking-wide hover:opacity-90 transition shadow-spotlight">
                ابدأ التدريب ←
              </a>
              <a href="#journey" className="px-8 py-4 border border-[color:var(--gold)]/40 text-[color:var(--gold)] hover:bg-[color:var(--gold)]/10 transition tracking-wide">
                شاهد المقدمة
              </a>
            </div>
            <div className="mt-14 flex gap-10 text-sm">
              <div><div className="font-display text-3xl text-[color:var(--gold)]">50+</div><div className="text-muted-foreground">حركة</div></div>
              <div><div className="font-display text-3xl text-[color:var(--gold)]">12K</div><div className="text-muted-foreground">طالب</div></div>
              <div><div className="font-display text-3xl text-[color:var(--gold)]">4.9★</div><div className="text-muted-foreground">تقييم</div></div>
            </div>
          </div>

          <div className="relative animate-fade-in">
            <div className="absolute -inset-10 bg-[color:var(--gold)]/10 blur-3xl rounded-full" />
            <div className="relative aspect-[3/4] overflow-hidden border border-[color:var(--gold)]/30 shadow-deep">
              ...
              <div className="absolute bottom-6 right-6 left-6 text-right" dir="rtl">
                <p className="font-display text-2xl text-[color:var(--gold)]">"إنه ليس عن الخطوة..."</p>
      ...
      <section id="moves" className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20" dir="rtl">
            <p className="text-[color:var(--gold)] text-sm tracking-[0.4em] mb-4">الفصول</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {moves.map((m, i) => (
              <article key={m.name} className="group relative bg-card border border-border overflow-hidden hover:border-[color:var(--gold)]/50 transition-all duration-500">
                <div className="aspect-[3/4] overflow-hidden relative">
                  ...
                  <div className="absolute top-4 right-4 font-display text-6xl text-[color:var(--gold)]/40">0{i + 1}</div>
                </div>
                <div className="p-6 text-right" dir="rtl">
                  ...
                  <p className="text-[color:var(--gold)]/80 text-sm mb-4">{m.arabic}</p>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-5">{m.desc}</p>
                  <div className="flex items-center justify-between border-t border-border pt-4">
                    <span className="text-xs px-3 py-1 border border-[color:var(--gold)]/30 text-[color:var(--gold)]">{m.level}</span>
                    <span className="text-sm group-hover:text-[color:var(--gold)] transition">تعلّم الآن ←</span>
                  </div>
                </div>
              </article>
            ))}
      ...
      <section id="journey" className="relative py-32 px-6 bg-stage">
        <div className="max-w-5xl mx-auto" dir="rtl">
          <div className="text-center mb-20">
            <p className="text-[color:var(--gold)] text-sm tracking-[0.4em] mb-4">المنهج</p>
            <h2 className="font-display text-5xl md:text-6xl">رحلتك إلى <span className="text-gradient-gold italic">الإتقان</span></h2>
          </div>

          <div className="space-y-12 relative">
            <div className="absolute right-8 top-0 bottom-0 w-px bg-gradient-to-b from-[color:var(--gold)] via-[color:var(--gold)]/30 to-transparent" />
            {[
              ...
              <div key={s.step} className="flex gap-8 items-start group">
                <div className="flex-shrink-0 w-16 h-16 border border-[color:var(--gold)]/40 flex items-center justify-center font-display text-2xl text-[color:var(--gold)] bg-background group-hover:bg-[color:var(--gold)] group-hover:text-primary-foreground transition">
                  {s.step}
                </div>
                <div className="pt-2">
      ...
      <section id="masterclass" className="relative py-32 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center" dir="rtl">
          <p className="text-[color:var(--gold)] text-sm tracking-[0.4em] mb-8">★  ماستركلاس  ★</p>
      ...
      <section id="join" className="relative py-32 px-6">
        <div className="max-w-4xl mx-auto text-center border border-[color:var(--gold)]/30 p-12 md:p-20 relative bg-card shadow-spotlight" dir="rtl">
          ...
          <p className="text-[color:var(--gold)] tracking-[0.4em] text-sm mb-6">★ ابدأ الليلة ★</p>
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              dir="rtl"
            />
            <button type="submit" className="px-8 py-4 bg-primary text-primary-foreground font-semibold hover:opacity-90 transition">
              انضم
            </button>
          </form>
        </div>
